...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "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", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "LOLKAUOLO", lambda m: self.strings("cfg_gh_user", m),

...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "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", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "seregabro0288", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "MODULEFTG", lambda m: self.strings("cfg_gh_repo", m))
